(function () {
	const button = document.querySelector('.accept-project__button');

	const container = document.querySelector(".firework");
	let isOpen = false;

	button.addEventListener("click", runFireworks);

	function runFireworks(btn) {
		button.removeEventListener("click", runFireworks);
	...
	! function (t, i) {
		if ("object" == typeof exports && "object" == typeof module) module.exports = i();
			...
			const s = i();
			for (const e in s) ("object" == typeof exports ? exports : t)[e] = s[e]
		}
	}(this, (function () {
		return (() => {
			"use strict";
			const t = {
				511: (t, i, s) => {
					...
					i.Explosion = class {
						constructor(t) {
							...
							for (this._coordinates = [], this._alpha = 1, this._x = i, this._y = s, this._ctx = n, this._gravity = o, this._friction = a, this._flickering = c, this._lineWidth = _, this._explosionLength = d; this._explosionLength--;) this._coordinates.push([i, s]);
						...
						draw() {
							const t = this._coordinates.length - 1;
				...
				909: (t, i) => {
					Object.defineProperty(i, "__esModule", {
						...
						const s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 1;
						return "hsla(".concat(t, ", 100%, ").concat(i, "%, ").concat(s, ")")
					}
				},
				449: function (t, i, s) {
					const e = this && this.__awaiter || function (t, i, s, e) {
					...
					i.Sound = class {
						...
						load() {
							return e(this, void 0, void 0, (function* () {
								for (const t of this.options.files) {
									const i = yield (yield fetch(t)).arrayBuffer();
				...
				668: (t, i, s) => {
					...
					i.Trace = class {
						constructor(t) {
							...
							for (this._coordinates = [], this._currentDistance = 0, this._x = i, this._y = s, this._sx = i, this._sy = s, this._dx = n, this._dy = h, this._ctx = o, this._hue = a, this._speed = r, this._traceLength = c, this._acceleration = _, this._totalDistance = (0, e.getDistance)(i, s, n, h); this._traceLength--;) this._coordinates.push([i, s]);
						...
						update(t) {
							...
							const i = Math.cos(this._angle) * this._speed,
				...
				t.Fireworks = class {
					...
					setOptions(t) {
						for (const [i, s] of Object.entries(t)) {
							const e = Object.prototype.hasOwnProperty.call(this, i);
					...
					render() {
						let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this._timestamp;
					...
					initExplosion(t, i, s) {
						for (let e = this.particles; e--;) this._explosions.push(new h.Explosion({
							x: t,
							y: i,
							ctx: this._ctx,
							hue: s,
					...
					drawExplosion() {
						for (let t = this._explosions.length; t--;) this._explosions[t].draw(), this._explosions[t].update((() => {
